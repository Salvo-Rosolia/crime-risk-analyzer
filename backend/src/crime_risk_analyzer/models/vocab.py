...
- ``confidence`` -> **minuscolo**: ``verificato`` / ``da_confermare``.
...
Confidence = Literal["verificato", "da_confermare"]
...
class ConfidenceSummary(BaseModel):
    ...
    Sostituisce il vecchio ``dict[str, int]``: i due livelli canonici diventano
